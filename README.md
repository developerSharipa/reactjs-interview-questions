...
| 8   | [Что такое состояние в React?](#what-is-state-in-react)                                                                                                                                                                               |
| 9   | [Что такое пропсы в React?](#what-are-props-in-react)                                                                                                                                                                             |
| 10  | [В чём разница между состоянием и пропсами?](#what-is-the-difference-between-state-and-props)                                                                                                                               |
| 11  | [Почему не стоит обновлять состояние напрямую?](#why-should-we-not-update-the-state-directly)                                                                                                                                     |
| 12  | [В чём цель функции обратного вызова в качетсве аругмента в setState()?](#what-is-the-purpose-of-callback-function-as-an-argument-of-setstate)                                                                                   |
| 13  | [В чем разница между обработкой событий в HTML и React?](#what-is-the-difference-between-html-and-react-event-handling)                                                                                                   |
| 14  | [Как привязать методы или обработчики событий в обратных вызовах JSX?](#how-to-bind-methods-or-event-handlers-in-jsx-callbacks)                                                                                                               |
| 15  | [Как передать параметр обработчику событий или обратному вызову?](#how-to-pass-a-parameter-to-an-event-handler-or-callback)                                                                                                             |
| 16  | [Что такое синтетические события в React?](#what-are-synthetic-events-in-react)                                                                                                                                                       |
| 17  | [Что такое встроенные условные выражения?](#what-are-inline-conditional-expressions)                                                                                                                                             |
...
| 19  | [В чем польза ссылок?](#what-is-the-use-of-refs)                                                                                                                                                                             |
| 20  | [Как создавать ссылки?](#how-to-create-refs)                                                                                                                                                                                       |
| 21  | [Что такое прямые ссылки?](#what-are-forward-refs)                                                                                                                                                                                 |
